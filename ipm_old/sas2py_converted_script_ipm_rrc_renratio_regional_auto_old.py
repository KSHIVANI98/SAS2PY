...
def GetPol(InfMon):
    ...
    *********************************************************************************'''
    ...
    sqliteConnection = sqlite3.connect(SQLitePythonWorkDb)
    with SAS7BDAT('/data02/sas2py_poc/act/ipm_rrc/ipm_rrc_renratio_regional_auto/data/inforce{}.sas7bdat'.format(InfMon)) as reader:
    ...
    *********************************************************************************'''
    ...
    # Open connection to Sqlite work data base
    sqliteConnection = sqlite3.connect(SQLitePythonWorkDb)
    with SAS7BDAT('/data02/sas2py_poc/act/ipm_rrc/ipm_rrc_renratio_regional_auto/data/inforcegenii{}.sas7bdat'.format(InfMon)) as reader:
        df = reader.to_data_frame()
        # putting into the sqliteDB
...
def Renew(InfMon):
    ...
    *********************************************************************************'''
    ...
    sqliteConnection = sqlite3.connect(SQLitePythonWorkDb)
    # reading the file from csv
    with SAS7BDAT('/data02/sas2py_poc/act/ipm_rrc/ipm_rrc_renratio_regional_auto/data/driver{}.sas7bdat'.format(InfMon)) as reader:
        df = reader.to_data_frame()
        # putting into the sqliteDB
    ...
    sqliteConnection = sqlite3.connect(SQLitePythonWorkDb)
    # reading the file from csv
    with SAS7BDAT('/data02/sas2py_poc/act/ipm_rrc/ipm_rrc_renratio_regional_auto/data/drivergenii{}.sas7bdat'.format(InfMon)) as reader:
        df = reader.to_data_frame()
        # putting into the sqliteDB
